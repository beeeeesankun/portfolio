...
$p = '本制作物は書道家『書き心』春流・破留のHPのリニューアル案件<br>です。クライアントとご縁があり、自身で営業から制作、サーバー<br>アップまでの一連の工程を経験しました。クライアントの解決したい<br>課題は、コロナウイルス流行の影響で、オンラインでの受注や制作物<br>の購入、スマートフォンからの顧客獲得でした。課題解決の為に、HP<br>から注文をできる様にPHPでお問い合わせフォームの実装をしました。<br>苦労したことはか解決したい課題の用件確定です。クライアントの今後<br>の活動や展望なども含めて、それを解決するデザインや機能とは？とい<br>う構想段階で上手くいかず、作ってはやり直しを何度も繰り返し、本制<br>作物を作り上げました。';
?>
<!DOCTYPE html>
<html lang="ja">
