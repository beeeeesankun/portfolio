    ...
    <div class="s_about_container">
      ...
      <div class="s_about_container_article-wrap">
        <article class="s_about_container_article anime">
          ...
          <p>
            制作物を作っていく過程でプログラムに非常多くのエラーが起きました。<br><br>その際に、どうして動かないのか？なぜエラーが出るのか？という仮説と検証、現時点での知らない知識の補完等を繰り返し行いました。<br><br>そして、一つのエラーが解消出来た時に非常に強い達成感と、点として散っていた知識が線となるような感覚を味わいました。<br><br>その没頭する感覚とウェブ上で自身の考えた物が形となる。そんなことに魅力と面白さを感じエンジニアを志すようになりました。
          </p>
        </article>
        <article class="s_about_container_article anime">
          <p class="s_about_container_article_title">長所・短所</p>
          <p>
            長所はスポーツで培ってきた集中力と継続力です。<br><br>私は幼少の頃から大学4年まで約18年間水泳を続けてきました。そこで、選手としての集中の仕方や努力の仕方を学びました。<br><br>また、中高大と最終学年では責任感を評価され部長・主将に任命されておりました。<br<br>>チームで目標を持って活動する難しさと、チーム一丸となった時のエネルギーとパワーの強さを学びました。<br><br>日々の学習の中でも、この長所と経験を生かして活動しています。<br><br>短所はオンとオフがはっきりしている所です。オフの際は省エネモードになります。<br><br>しかし、リラックスできるオフがあるからこそのオンだと思っているので、オンの際は集中力が高く、良いパフォーマンスを発揮できます。
          </p>
        </article>
        <article class="s_about_container_article anime">
          <p class="s_about_container_article_title">提供できる価値</p>
          <p>
            現場経験が少ないということもあり、技術力では既存のエンジニアの方には到底敵いません。<br><br>しかし、私には伸び代と未熟さ故のハングリー精神があります。<br><br>また、水泳で培ってきた選手としての経験や責任感があります。<br><br>よって成長スピードと取り組む姿勢で周りに影響を与えることが今の私が提供できる価値だと考えております。
          </p>
        </article>
      </div>
    </div>
